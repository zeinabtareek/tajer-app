                        ...
                        Opacity(
                          ...
                          child: Column(
                            children: [
                              ...
                              K.sizedboxH,
                       //        Obx(()=>   (controller.searchController.value!='')?
                       //        // Obx(()=>   (controller.searchedOrder.id !=null &&controller.searchController.value!='')?
    ...
    controller.searchLoader.value?Center(
      child: CupertinoActivityIndicator(
        color: K.primaryColor,
                            ...
                            Image.asset(AssetImages.noOrders,height: 150,):ListView.builder(
                                  shrinkWrap: true,
