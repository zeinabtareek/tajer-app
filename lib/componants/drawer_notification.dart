            ...
            child: Padding(
              ...
              child: SingleChildScrollView(
                child: Column(
                  children: [
                    AppBar(
                      // actions: [Icon(Icons.arrow_forward_ios_outlined,size: 15.sp,)],
                      leading:SizedBox(),
                        ...
                        itemBuilder: (context, index) {
                          return (controller.notifications!.data![index]
                            ...
                            child: Card(
                                      ...
                                      Expanded(
                                        ...
                                        child: ClipRRect(
                                          ...
                                          child: CachedNetworkImage(
                                            imageUrl: controller.notifications?.data?[index].image ?? '',
                                  ...
                                  Text(
                                    controller.
                                    getTimeDifference(controller.currentDateTime,  controller.notifications?.data?[index].date??'' ,

                                    ),
                                    style:
                                    TextStyle(color: K.mainColor,fontSize: 12.sp),
                                  ),
                                  K.sizedboxH,
                                ],
                              )
                            ...
                            children: [
                             ...
                             style:   TextStyle(color: K.mainColor,fontSize: 12.sp),
                              ),
                              K.sizedboxH,
                            ],
                          );
